...
//console.log(Object.keys(carMarket));

//! agency's func's
//todo getters

function getAgencyByName(string) {
  return carMarket.sellers.find(
    (agency) => sellers[agency.agencyName] === string
  );
}
...
carMarket.getAgencyByName = function (string) {
  //[]
  const agency = this.sellers.find((agencyObject) => {
    return string === agencyObject.name;
  });
};
